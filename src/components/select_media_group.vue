                            ...
                            " class="drag" draggable="true" @dragstart.stop="handleMediasDragStart($event, item)"
                                ...
                                <div class="item-media">
                                    <div v-for="(row, key) in config.showMediaColumn" :key="key" :style="row.style"
                                        ...
                                        <span>
                                            {{ row.column === "key" ? index + 1 : (row.column === 'length' ? formatSecondNo(item[row.column]) : item[row.column]) }}
                                        </span>
                                    </div>
                                    <div class="icon-font-delete">
                                        <i class="iconfont icon-clear delete"
                                            @click="deleteTerminal(item)"></i>
                                    </div>
                                </div>
                            </li>
                        </template>
                            ...
                            ">
                                <div class="item-media">
                                    <div v-for="(row, key) in config.showMediaGroupsColumn" :key="key"
                                        ...
                                        <span>
                                            {{ row.column === "key" ? index + 1 : (row.column === 'length' ? formatSecondNo(Number(item[row.column])) : item[row.column]) }}
                                        </span>
                                    </div>
                                    <div class="icon-font-delete">
...
// import usePublicMethod from "@/global/index";
