...
<template>
    <div class="com-select-terminals-groups">
        ...
        <!-- 已选终端 -->
        <div class="com-select-right" v-show="form.activeName === 'first'" v-if="config.isSelectTerminals">
            <div class="custom-right-title">
                <div v-for="(item, index) in config.showTerminalsColumn" :key="index" :style="item.style">
                    <template v-if="
                    ...
                    <ul class="scroll-ul">
                        <template v-for="(item, index) in form.selectedTerminalsData" :key="item.id">
                            ...
                            ">
                                ...
                                <div class="item-amplifier" v-if="config.selectAmplifier && item.isShowAmplifier">
                                    <div class="amplifier-checkbox">
                                        <span>{{ config.amplifierTitle }}</span>
                                        <el-checkbox v-model="item.checkAll_amplifier"
                                            :indeterminate="item.isIndeterminate"
                                            @change="handleCheckAllAmplifierChange(item)">
                                            全选
                                        </el-checkbox>
                                        <el-checkbox-group v-model="item[config.amplifierColumnName]"
                                            @change="handleSelectAmplifierChange(item)">
                                            <el-checkbox v-for="row in config.amplifierValue" :key="row" :label="row">
                                                {{ row }}
                                            </el-checkbox>
                                        </el-checkbox-group>
                                    </div>
        ...
        <div class="com-select-right" v-show="form.activeName === 'second'" v-if="config.isSelectGroups">
            <div class="custom-right-title group">
                <div v-for="(item, index) in config.showTerminalsGroupsColumn" :key="index" :style="item.style">
                    <template v-if="
                        item.column !== config.searchColumnName ||
                    ...
                    <span v-else>
                        <el-input class="title-search-input" v-model="form.selectedSearchGroups" placeholder="分组名称"
