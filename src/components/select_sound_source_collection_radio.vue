    ...
    <div class="com-select-sound-source-collection">
                ...
                <el-scrollbar>
                    <ul class="scroll-ul">
                        <template v-for="item in form.allSoundSourceData" :key="item.id">
                            <li @click="handleCurrentClickGroups(item)"
        ...
        <div class="com-select-right" v-show="form.currentGroupsID === 1">
            <div class="custom-title">
                <div v-for="(item, index) in config.showSoundCardColumn" :key="index" :style="item.style">
                    <span>{{ item.text }}</span>
                </div>
            </div>
            <div class="custom-content">
                <el-scrollbar>
                    <ul class="scroll-ul">
                        <template v-for="(item, index) in form.allSoundCardData" :key="item.id">
                            <li @click="handleSelectedSoundSource(item)" :class="{
        ...
        <div class="com-select-right" v-show="form.currentGroupsID === 2">
            <div class="custom-title">
                <div v-for="(item, index) in config.showAcquisitionColumn" :key="index" :style="item.style">
                    <template v-if="
            ...
            <div class="custom-content">
                <el-scrollbar>
                    <ul class="scroll-ul">
                        <template v-for="(item, index) in form.allAcquisitionTerminalData" :key="item.id">
                            <li @click="handleSelectedSoundSource(item)" :class="{
                            ...
                            ">
                                <div class="icon-font-select" v-if="form.selectedSoundSourceData?.id === item.id">
                                    <el-icon class="theme"><Select /></el-icon>
                                </div>
                                <div v-for="(row, key) in config.showAcquisitionColumn" :key="key" :style="row.style"
