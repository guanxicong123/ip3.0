        ...
        <el-dialog v-model="dialogUserName" title="修改账号" width="30%" :before-close="handleClose"
            ...
            <el-form ref="ruleFormNameRef" :rules="rulesName" :model="userNameForm" v-loading="loadingUserPass"
                ...
                <el-form-item prop="name">
                    <el-input type="text" auto-complete="off" v-model="userNameForm.name" :maxlength="100" placeholder="请输入 1-100 字母/数字/_组合"
                        clearable suffix-icon="">
                        <template #prefix>
...
const ruleFormNameRef = ref<FormInstance>();
...
const validateUserName = (rule: any, value: any, callback: any) => {
    ...
    console.log(value, validate.test(value))
    if (!value) {
