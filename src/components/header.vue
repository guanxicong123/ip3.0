...
<template>
    <div class="broadcast-header">
        ...
        <el-dialog v-model="dialogUserName" title="修改账号" width="30%" :before-close="handleClose"
            class="com-default-dialog">
            <el-form ref="ruleFormNameRef" :rules="rulesName" :model="userNameForm" v-loading="loadingUserPass"
                element-loading-text="Loading...">
                <el-form-item prop="name">
                    <el-input type="text" auto-complete="off" v-model="userNameForm.name" :maxlength="100"
                        placeholder="请输入 1-100 字母/数字/_组合" clearable suffix-icon="" :spellcheck="false">
                        <template #prefix>
            ...
            <template #footer>
                <span class="dialog-footer">
                    <el-button @click="dialogUserName = false; userNameForm.name = ''">取消</el-button>
                    <el-button type="primary" @click="handleChangeUser(ruleFormNameRef)">确认</el-button>
                </span>
            </template>
        </el-dialog>
        <el-dialog v-model="dialogUserPass" title="修改密码" width="30%" :before-close="handleClose"
            class="com-default-dialog">
            <el-form ref="ruleFormRef" :rules="rules" :model="userPasswordForm" v-loading="loadingUserPass"
                element-loading-text="Loading...">
                <el-form-item prop="old_password">
                    <el-input type="password" v-model.trim="userPasswordForm.old_password" :maxlength="20"
                        placeholder="请输入旧密码" clearable show-password auto-complete="new-password" oncopy="return false"
                        onpaste="return false" ondragstart="return false" onselectstart="return false"></el-input>
                </el-form-item>
                <el-form-item prop="password">
                    <el-input type="password" v-model.trim="userPasswordForm.password" :maxlength="20"
                        placeholder="输入新密码" clearable show-password auto-complete="new-password" oncopy="return false"
                        onpaste="return false" ondragstart="return false" onselectstart="return false"></el-input>
                </el-form-item>
                <el-form-item prop="confirm_password">
                    <el-input type="password" v-model.trim="userPasswordForm.confirm_password" :maxlength="20"
                        placeholder="确认输入新密码" clearable show-password auto-complete="new-password" oncopy="return false"
                        onpaste="return false" ondragstart="return false" onselectstart="return false"></el-input>
                </el-form-item>
            </el-form>
            <template #footer>
        ...
        <el-dialog v-model="dialogVersionNo" title="关于" width="30%" :before-close="handleClose"
            class="com-default-dialog">
        ...
        <el-dialog v-model="dialogLogOut" title="警告" width="30%" :before-close="handleClose" class="com-default-dialog">
            <div class="com-default-dialog-test">
                <div class="com-default-dialog-content">
                    <p>即将退出登录？</p>
                </div>
