            ...
            >
              ...
              >
                <div
                  ...
                  @mouseenter.stop="item.hover = true"
...
const sidebarData = ref([
  ...
  },
  {
    ...
    hover: false,
    children: [
      { name: proxy.$t("System configuration"), path: "/system/configure" },
      { name: proxy.$t("Log management"), path: "/system/log" },
    ],
  },
]);
// 路由
