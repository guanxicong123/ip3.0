...
<template>
  <div class="broadcast-register">
    <div class="broadcast-register-header">
        ...
        <div class="broadcast-register-meagess" v-if="registerStatus?.freeTime > 0 && !isRegister">
            <p>
                请联系厂商注册，软件剩余体验
        ...
        <div class="broadcast-register-button">
            ...
            <span class="button-submit" v-if="!isRegister" @click="isRegister = true">注册</span>
...
const close = () => {
    ...
    if (registerStatus.value?.freeTime === 0) { //未注册，使用时长为0，关闭时连带关闭主窗口
