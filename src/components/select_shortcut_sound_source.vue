        ...
        <div class="com-select-right" v-show="form.selectedConfigureData.type === 1">
            ...
            <div class="custom-title">
                <div v-for="(item, index) in config.showMediaColumn" :key="index" :style="item.style">
                    ...
                    <span v-else>
                        <el-input class="title-search-input" v-model="form.selectedSearchConfigure"
                            placeholder="媒体/媒体文件夹" maxlength="100" clearable @input="handleSelectedConfigureSearch" />
...
const getSoundSource = () => {
    return new Promise<void>((resolve, reject)=> {
        global.$http.get('/fast-sound/all', {
            params: {
                withUser: true,
                withMedias: true
            }
