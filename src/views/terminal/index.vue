            ...
            <div class="com-head-content">
                <div class="com-breadcrumb">
                    ...
                    <div class="play-table-title">
                        <span :class="{ theme: $useRoute.name != 'group' }" @click="changeRouter('终端')">
                            全部终端
                        </span>
                        <span class="line"> | </span>
                        <span :class="{ theme: $useRoute.name == 'group' }" @click="changeRouter('分组')">
                            分组
                        </span>
                    </div>
                    <el-select v-show="$useRoute.name != 'group'" v-model="form.terminal_status"
                        style="margin-left: 10px" @change="handleFilter()">
                ...
                <div class="com-button">
                    <span>主讲终端</span>
                    <el-select v-model="form.speaker_terminal" style="margin-left: 10px" :disabled="sessionsData.length > 0">
                        <el-option v-for="(item, keys) in form.speakerTerminalOptions" :key="keys"
                            :label="item.name" :value="item.EndPointID" />
                    </el-select>
                </div>
            </div>
        </div>
            ...
            <div class="terminal-config-items">
                ...
                <span class="view-number-config">
                    ...
                    <el-select v-model="form.select_terminal" :disabled="form.view_value === 'list'">
                        <el-option v-for="item in terminal_view_options" :key="item.value" :label="item.value"
                            :value="item.value" />
                    </el-select>
                </span>
            </div>
