...
<template>
    <div class="com-source-acquisition-component">
        <select-sound-source-collection-radio :responseSoundSource="responseSoundSource"
            @requestSoundSource="requestAcquisitionTerminal" @requestType="requestType">
        ...
        <!-- 选择文件夹路径 -->
        <el-dialog v-model="folderDialogVisible" width="800px" destroy-on-close draggable append-to-body
...
onMounted(() => {
    if (Object.prototype.hasOwnProperty.call(props.selectTaskData, "type")) {
        ...
        if (Object.prototype.hasOwnProperty.call(props.selectTaskData?.content, "terminalID")) {
