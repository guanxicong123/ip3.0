    ...
    <div class="com-sound-source-component">
        <el-form :model="ruleForm" :label-position="props.labelPosition"
            ...
            <el-row :gutter="80">
                ...
                <el-col :xs="props.adaption.xs" :sm="props.adaption.sm" :md="props.adaption.md" :lg="props.adaption.lg"
                ...
                <el-col :xs="props.adaption.xs" :sm="props.adaption.sm" :md="props.adaption.md" :lg="props.adaption.lg"
                    :xl="props.adaption.xl" v-if="isMusicPlay && ruleForm.play_model !== 0">
                    <el-form-item>
                        <el-radio :disabled="!props.isEdit" v-model="ruleForm.radioVal" :label="1"
                ...
                <el-col :xs="props.adaption.xs" :sm="props.adaption.sm" :md="props.adaption.md" :lg="props.adaption.lg"
                    :xl="props.adaption.xl" v-if="isMusicPlay && ruleForm.play_model !== 0">
                    <el-form-item>
                        <el-radio :disabled="!props.isEdit" v-model="ruleForm.radioVal" :label="2"
                            style="height: 22px; margin-bottom: 8px">
                            播放曲目
                        </el-radio>
                        <el-input v-model="ruleForm.play_number" :disabled="ruleForm.radioVal !== 2 || !props.isEdit" />
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
