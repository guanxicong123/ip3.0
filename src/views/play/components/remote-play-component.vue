    ...
    <div class="com-remote-play-component">
        ...
        <el-form :model="ruleForm" label-position="top" class="play-task-form-inline">
            <el-row :gutter="80">
                ...
                <el-col :xs="12" :sm="8" :md="8" :lg="8" :xl="6" v-if="ruleForm.play_model !== 0">
                    <el-form-item>
                        <el-radio v-model="ruleForm.radioVal" :label="1" style="height: 22px; margin-bottom: 8px">持续时间
                        </el-radio>
                ...
                <el-col :xs="12" :sm="8" :md="8" :lg="8" :xl="6" v-if="ruleForm.play_model !== 0">
                    <el-form-item>
                        <el-radio v-model="ruleForm.radioVal" :label="2" style="height: 22px; margin-bottom: 8px">播放曲目
                        </el-radio>
