                ...
                <el-row :gutter="80">
                    ...
                    <el-col :xs="12" :sm="80" :md="80" :lg="80" :xl="80" v-show="ruleForm.is_txt">
                        <el-form-item label="文本路径">
                            <el-upload ref="uploadRef" class="upload-demo" accept=".txt"
                                action="https://run.mocky.io/v3/9d059bf9-4660-45f2-925d-ce80ad6c4d15"
                                :disabled="!props.isEdit" :auto-upload="false" :show-file-list="false"
                    ...
                    <el-col :xs="80" :sm="80" :md="80" :lg="80" :xl="80" v-show="!ruleForm.is_txt">
                        <el-form-item label="文本内容">
                            <el-input v-model="ruleForm.ttscontent" :rows="5" type="textarea"
                                placeholder="请输入内容（不超过1000字）" show-word-limit maxlength="1000"
                                :disabled="!props.isEdit" />
                        </el-form-item>
                    </el-col>
                    <el-col :xs="80" :sm="80" :md="80" :lg="80" :xl="80" v-show="!ruleForm.is_txt">
                        <el-form-item>
                            <el-checkbox v-model="ruleForm.enabledplayfun" :disabled="!props.isEdit"
                    ...
                    <el-col :xs="12" :sm="8" :md="8" :lg="8" :xl="6" v-show="!ruleForm.is_txt">
                        <el-form-item label="显示属性">
                            <el-select v-model="ruleForm.displayattribute" :disabled="!props.isEdit">
                                ...
                                <el-option v-for="item in dispProperOption" :key="item.id" :label="item.name"
                                    :value="item.id" />
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :xs="props.adaption.xs" :sm="props.adaption.sm" :md="props.adaption.md"
                        :lg="props.adaption.lg" :xl="props.adaption.xl">
                        <el-form-item label="播放语音">
                            <el-select v-model="ruleForm.ttsenginename" :disabled="!props.isEdit">
                                <el-option v-for="item in playVoiceOptions" :key="item.EngineIndex"
                                    :label="item.EngineName" :value="item.EngineName" />
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :xs="props.adaption.xs" :sm="props.adaption.sm" :md="props.adaption.md"
                        ...
                        <el-form-item label="播放语速">
                            <el-select v-model="ruleForm.ttsspeed" class="custom-el-select" :disabled="!props.isEdit">
                                <el-option v-for="item in playSpeedOption" :key="item" :label="formatterSpeed(item)"
                                    :value="item" />
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :xs="props.adaption.xs" :sm="props.adaption.sm" :md="props.adaption.md"
                        ...
                        <el-form-item label="播报次数">
                            <el-input-number v-model="ruleForm.repeattime" :min="1" controls-position="right"
                                :disabled="!props.isEdit" />
                        </el-form-item>
                    </el-col>
                </el-row>
