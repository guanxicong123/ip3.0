...
<!-- 
  ...
  @FilePath: src\views\session\components\select_monitoring_speaker.vue
  @Describe: 选择监听音箱弹窗
-->
<template>
  <div class="com-view-components">
    ...
    <el-button ref="viewRef" v-click-outside="onClickOutside">
      ...
      <i
        ...
        v-if="form.currentTableRow.EndPointID > 0"
...
const form = reactive<any>({
  ...
  currentSelectedName: proxy.$t("Please select an idle terminal"),
});
// 获取refs
const viewRef = ref();
...
const handleRemoveSelected = () => {
  ...
  form.currentTableRow = {
    EndPointID: 0,
    EndPointName: "",
  };
  form.currentSelectedName = proxy.$t("Please select an idle terminal");
};
